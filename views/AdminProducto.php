...
<!-- con este codigo muestra el sweetalert de que se elimino el producto -->
        <?php
            ...
            session_start();
            if (isset($_SESSION['suit4']) && $_SESSION['suit4'] === true){
                echo '<script>
                swal({
                    title: "¡Producto actualizado con exito!",
                    text: "Tu producto se ha actualizado en el catalogo.",
                    icon: "success",
                    button: "Genial"
                    });
                </script>';
            unset($_SESSION['suit4']);         
            }
...
<script src="../assets/camilo/JS/modal.js"></script>    
        <div class="text-center mt-4">
           <a href="/index_citas.php" class="btn btn-warning btn-lg">Volver a citas</a>
           <a href="AdminCrearP.php" class="btn btn-success btn-lg">Crear producto</a>
           <a href="pedidos.php" class="btn btn-danger btn-lg">ver pedidos</a>
        </div>
 </div>
</body>
</html>
