                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu p-3" aria-labelledby="ayudaDropdown">
                            <li>
                                ...
                                <a class="dropdown-item text-primary" href="https://www.youtube.com/watch?v" target="_blank">https://www.youtube.com/watch?v=rbzzgMrICAw&list=PLfD2XmGTbofHHlvoQBeF04sdtLbBZ6Uw4&index=2</a>
                            </li>
                            <li>
                                <span class="dropdown-item-text fw-bold">Reserva de Productos</span>
                                <a class="dropdown-item text-primary" href="https://www.youtube.com/watch?v=fxKCTTYIPYA&list=PLfD2XmGTbofHHlvoQBeF04sdtLbBZ6Uw4&index=1" target="_blank">https://www.youtube.com/watch?v=fxKCTTYIPYA&list=PLfD2XmGTbofHHlvoQBeF04sdtLbBZ6Uw4&index=1</a>
                            </li>
                        </ul>
                    </li>
